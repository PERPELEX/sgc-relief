            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                    <div className="text-2xl font-bold flex items-center">
                        <span
                            className={`mr-2 cursor-pointer hidden md:flex ${isIconClicked ? 'text-green-500 rotate-90' : 'text-white rotate-0'} hover:text-green-500 transition-all duration-300`}
                ...
                <nav className="flex items-center space-x-8">
                    ...
                    <span
                        className={`mr-2 cursor-pointer flex md:hidden ${isIconClicked2 ? 'text-green-500 -rotate-90' : 'text-white rotate-0'} hover:text-green-500 transition-all duration-300`}
