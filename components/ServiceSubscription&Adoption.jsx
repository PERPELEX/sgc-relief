...
export default function ServiceSubscriptionAdoption() {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center gap-12  lg:p-8">
      {/* Image */}
      <div className="hidden  bg-white rounded-2xl shadow-lg p-4 lg:p-8 md:flex items-center w-full lg:w-auto">
        <div
          className=" w-full h-[400px] lg:w-[400px] lg:h-[650px] rounded-2xl shadow-lg bg-cover bg-center flex flex-col justify-end"
          style={{ backgroundImage: `url(/samplePic2.jpg)` }}
        ></div>
      </div>

      {/* Services */}
      <div className="flex flex-col justify-center items-center gap-12 w-full lg:w-auto">
        {/* Service 1 */}
