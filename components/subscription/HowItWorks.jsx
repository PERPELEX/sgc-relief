...
const HowItWorks = () => {
  return (
    <div className="bg-white py-12 px-8 md:px-16 lg:px-32 flex flex-col justify-center gap-12 rounded-2xl shadow-lg">
      {/* Title */}
      ...
      <div className="flex justify-center items-start relative">
        ...
        <div className="flex flex-col items-end gap-24 pr-8 py-16">
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-28 text-gray-800 mr-10"
          >
            <path
              strokeLinecap="round"
        ...
        {/* Central Line */}
        <div className="absolute left-1/2 top-0 h-full border-r-2 border-l border-solid border-[#22C55E] transform -translate-x-1/2"></div>

        {/* Right Column */}
        <div className="flex flex-col items-start gap-24 pl-8 py-16">
          {/* icon1 */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-28 text-gray-800 ml-10"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
